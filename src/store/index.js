    ...
    state: {
        ...
        subtitleFormats: [
            ...
            },
            {
                name: 'scc',
                extension: 'scc',
                title: 'Scenarist Closed Captions',
                description: 'SCC is the broadcast industry standard used for TV, DVDs, and Apple TV. It is encoded in hexadecimal control codes based on the CEA-608 specification. (Input only)',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/x-scc',
            },
            {
                name: 'dfxp',
                extension: 'dfxp',
                title: 'Distribution Format Exchange Profile',
                description: 'DFXP is an XML-based subtitle format that is an older profile of the TTML standard. Widely used in early streaming architectures and broadcast interchange.',
                canConvertFrom: true,
                canConvertTo: true,

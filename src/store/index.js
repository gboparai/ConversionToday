    ...
    state: {
        ...
        archiveFormats: [
            ...
            },
            {
                name: 'ar',
                extension: 'ar',
                title: 'UNIX Archive (ar)',
                description: 'UNIX static-library archive container format used by .a, .deb, and related package internals.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                description: 'Debian binary package container that can be opened and extracted as archive input.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                name: 'udeb',
                extension: 'udeb',
                title: 'Debian Installer Package',
                description: 'Debian installer package variant handled as archive input for extraction.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/vnd.debian.binary-package',
            },
            {
                ...
                extension: 'arj',
                title: 'ARJ Archive',
                description: 'Legacy compressed archive format used by classic DOS and Windows tooling.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                description: 'Cabinet archive used by Microsoft software installers and updates.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                description: 'Microsoft compiled help file container that can be unpacked as an archive.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                description: 'macOS disk image container format that can be extracted like an archive.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                name: 'esd',
                extension: 'esd',
                title: 'Electronic Software Download Image',
                description: 'Microsoft ESD image format that can be read as an archive source.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                name: 'hfsx',
                extension: 'hfsx',
                title: 'HFSX Filesystem Image',
                description: 'Case-sensitive HFSX filesystem image format that can be read as archive input.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/x-hfs',
            },
            {
                name: 'lzh',
                extension: 'lzh',
                title: 'LZH/LHA Archive',
                description: 'Legacy compressed archive format also known as LHA.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                extension: 'lha',
                title: 'LHA Archive',
                description: 'LHA extension variant of LZH compressed archives used by legacy tools.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/x-lzh-compressed',
            },
            {
                ...
                description: 'Package container format (including Apple package variants) readable as archive input.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                description: 'Windows provisioning package format readable as archive input.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/x-ms-wim',
            },
            {
                ...
                extension: 'rpm',
                title: 'RPM Package',
                description: 'RPM package container that can be read and extracted as archive input.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                description: 'Windows Imaging archive format used for deployment and recovery images.',
                canConvertFrom: true,
                canConvertTo: true,
                mimeType: 'application/x-ms-wim',
            },
            {
                name: 'swm',
                extension: 'swm',
                title: 'Split WIM Image',
                description: 'Split Windows Imaging Format segment that can be processed as archive input.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/x-ms-wim',
            },
            {
                ...
                extension: 'xar',
                title: 'XAR Archive',
                description: 'eXtensible ARchive format used by some macOS and package workflows.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                extension: 'xip',
                title: 'XIP Archive',
                description: 'Signed XIP package archive format used by Apple distribution workflows.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/x-xip',
            },
            {
                name: 'z',
                extension: 'z',
                title: 'UNIX Compress Archive',
                description: 'Legacy UNIX compress stream format that can be read as archive input.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                ...
                extension: 'gz',
                title: 'Gzip Stream',
                description: 'Gzip-compressed stream format available as extraction input.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/gzip',
            },
            {
                ...
                extension: 'bz2',
                title: 'Bzip2 Stream',
                description: 'Bzip2-compressed stream format available as extraction input.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/x-bzip2',
            },
            {
                ...
                extension: 'xz',
                title: 'XZ Stream',
                description: 'XZ-compressed stream format available as extraction input.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/x-xz',
            },
            {
                ...
                extension: 'lzma',
                title: 'LZMA Stream',
                description: 'LZMA-compressed stream format available as extraction input.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                name: 'zst',
                extension: 'zst',
                title: 'Zstandard Stream',
                description: 'Zstandard-compressed stream format available as extraction input.',
                canConvertFrom: true,
                canConvertTo: false,
            ...
            },
            {
                name: 'tzst',
                extension: 'tzst',
                title: 'Compressed TAR Archive (Zstandard)',
                description: 'A TAR archive compressed with Zstandard, commonly distributed as .tar.zst or .tzst.',
                canConvertFrom: true,
                canConvertTo: false,
                mimeType: 'application/zstd',
            },
